...
namespace MT1
{
    public class GameMT1 : Game
    {
        private GraphicsDeviceManager graphics;
        private SpriteBatch spriteBatch;

        string dir = @"C:\Users\juuso\OneDrive\Yliopisto\UC\Game Programming Techniques\MT\Art\";
        ...
        protected override void LoadContent()
        {
            ...
            texBlock1 = Util.texFromFile(GraphicsDevice, dir + "Mountain2.png");
            ...
            block1.setMoveAngleDegrees(-180);
